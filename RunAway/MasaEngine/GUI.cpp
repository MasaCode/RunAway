...
namespace MasaEngine{
	...
	CEGUI::OpenGL3Renderer* GUI::_renderer = nullptr; //definision for static member variable
	...
	CEGUI::Window* GUI::createWidget(CEGUI::Window* parent, const std::string& type, glm::vec4& destRectPerc, glm::vec4& destRectPix, const std::string& name){
		CEGUI::Window* newWindow = CEGUI::WindowManager::getSingleton().createWindow(type, name);
	...
	void GUI::setWidgetDestRect(CEGUI::Window* widget, const glm::vec4& destRectPerc, glm::vec4& destRectPix){
